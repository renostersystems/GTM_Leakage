...
SCEN = ExtRot or SetAside
FORTYPE = AllForest (or another specific forest type scenario)
IMPRATE = XXpct
...
-RENTZ(CTRY,LC1,T) +
RENTA(CTRY,LC1,T)*{[SUM(A1,YACRE2.L(CTRY,LC1,A1,T) + YACRE2L.L(CTRY,LC1,A1,T)+YACRE3.L(CTRY,LC1,A1,T) +
...
-RENTZ(CTRY,LC1,T)*
[SUM(A1,YACRE2.L(CTRY,LC1,A1,T) + YACRE2L.L(CTRY,LC1,A1,T)+
YACRE3.L(CTRY,LC1,A1,T) +YACRIN1.L(CTRY,LC1,A1,T))+EPSILON]+
{1/((1/RENTB(CTRY,LC1))+1)}*RENTA(CTRY,LC1,T)*
[SUM(A1,YACRE2.L(CTRY,LC1,A1,T) + YACRE2L.L(CTRY,LC1,A1,T)+
YACRE3.L(CTRY,LC1,A1,T) +YACRIN1.L(CTRY,LC1,A1,T))+EPSILON]**{(1/RENTB(CTRY,LC1))+1}
-
...
* redo this at end
execute_unload "GTM_LEAKAGE_SCENARIO_OUTPUT.gdx";
...
(ACHR2.L(CTRY,LC1,A1,T)+ACHR2l.L(CTRY,LC1,A1,T))*
...
SUM[LC1$(R1FOR(CTRY,LC1) EQ 1),
SUM(A1, (ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T))*
YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))];
...
TFOREST(CTRY,T)= SUM(LC1,SUM(A1,YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T)))+ SUM(LC1,SUM(A1,YACRE3.L(CTRY,LC1,A1,T)))+
        SUM(LC1, SUM(A1,YACRIN1.L(CTRY,LC1,A1,T)));

PARAMETER TFORESTLC(CTRY,LC1,T);
TFORESTLC(CTRY,LC1,T)= SUM(A1,YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))+ SUM(A1,YACRE3.L(CTRY,LC1,A1,T)+
YACRIN1.L(CTRY,LC1 ,A1,T));

PARAMETER ALLTIMBER(T);
ALLTIMBER(T)= SUM(CTRY,
SUM(LC1,SUM(A1,YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T)))+ FORACI1(CTRY,T));
...
FILE GTM_LEAKAGE_SCENARIO_OUTPUT; PUT GTM_LEAKAGE_SCENARIO_OUTPUT; GTM_LEAKAGE_SCENARIO_OUTPUT.PC=5;
...
*accessible timber
SUM(A1,(ACHR2.L('1',LC1,A1,T) +ACHR2l.L('1',LC1,A1,T))*
YIELD2('1',LC1,A1,T)*PARAM2('1',LC1,'8')*
...
TUSFORESTACC(LC1,T)= SUM(A1,YACRE2.L('1',LC1,A1,T) +YACRE2L.L('1',LC1,A1,T));
...
TUSFORESTSEMACC(LC1,T)= SUM(A1,(YACRE2.L('1',LC1,A1,T) +YACRE2L.L('1',LC1,A1,T))$(TEMPINAC('1',LC1) EQ 1));
...
[CPARAM2(CTRY,LC1,'3')*SUM(A1,(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*
((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))]$(TROPINAC(CTRY,LC1) EQ 1)
+
...
*tropical semi-inaccessible type
[CPARAM2(CTRY,LC1,'3')*SUM(A1,(YACRE2.L(CTRY,LC1,A1,T)+
YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*
((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))]$(TROPINAC(CTRY,LC1) EQ 1)
+
...
[
SUM(A1, (YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*AADJ(A1)*
...
[
(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*
...
[
(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*AADJ(A1)*
...
CPARAM2(CTRY,LC1,'17')*[SUM(A1, (YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T)))] $(R1FOR(CTRY,LC1) EQ 1)
+


CPARAM2(CTRY,LC1,'14')*CPARAM2(CTRY,LC1,'15')*(1+CPARAM2(CTRY,LC1,'16'))*
CPARAM2(CTRY,LC1,'17')*[SUM(A1, (YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYLDINAC(CTRY,LC1,A1,T)*
...
ABVCHEATHAGE(CTRY,LC1,A1,T)/(
YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T)
+YACRIN1.L(CTRY,LC1,A1,T)+EPSILON);
...
CPARAM2(CTRY,LC1,'3')*[(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T))] $(R1FOR(CTRY,LC1) EQ 1)
+

*tropical semi-inaccessible type
[CPARAM2(CTRY,LC1,'3')*(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYLDINAC(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*
((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T))]$(TROPINAC(CTRY,LC1) EQ 1)
+
...
LITTERACCAGE(CTRY,LC1,A1,T)$(R1FOR(CTRY,LC1) EQ 1) = (YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CPARAM2(CTRY,LC1,'28')*
[CYIELD(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T))]/
...
{[CPARAM2(CTRY,LC1,'28')*(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)]/
...
ACPL2.L(CTRY,LC1,T) + ACPL2L.L(CTRY,LC1,T) - SUM(A1,ACHR2.L(CTRY,LC1,A1,T)+ACHR2L.L(CTRY,LC1,A1,T)
+ACHRIN1.L(CTRY,LC1,A1,T))+
       CCNAC1(CTRY,LC1,T));
...
CSOILR1(CTRY,LC1,T)$(R1FOR(CTRY,LC1) EQ 1) = CPARAM2(CTRY,LC1,'5')*SUM(A1,FORINV2(CTRY,LC1,A1)+CPOLICY(CTRY,LC1,A1))+
SOILC1(CTRY,LC1,T)+
...
CPARAM2(CTRY,LC1,'5')*(SUM(A1,YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T)
+YACRIN1.L(CTRY,LC1,A1,T)))
...
SUM(A1,ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T))- SUM(A1,ACHR3.L(CTRY,LC1,A1,T))-
...
*GSV1(CTRY,LC1,A1,T) = CYIELD(CTRY,LC1,A1,T)*(YACRE2.L(CTRY,LC1,A1,T) +YACRE2L.L(CTRY,LC1,A1,T));
...
AREAHARVESED(CTRY,LC1,T)= SUM(A1,ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)
+ ACHRIN1.L(CTRY,LC1,A1,T) + ACHR3.L(CTRY,LC1,A1,T));
...
(IMGMT1.L(CTRY,LC1,T))*(ACPL2.L(CTRY,LC1,T) +
ACPL2L.L(CTRY,LC1,T))$(R1FOR(CTRY,LC1) EQ 1)
...
CSA(CTRY,LC1,'1')*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON )*YIELD2(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))$(R1FOR(CTRY,LC1) EQ 1)

+

[
{(1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*
...
+
(1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*
CSA(CTRY,LC1,'3')*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*
     PARAM2(CTRY,LC1,'8')*((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))$(TEMPINAC(CTRY,LC1) EQ 1)

+
[{(1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)
+EPSILON)*YIELD2(CTRY,LC1,A1,T)*
...
+
(1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*
CSA(CTRY,LC1,'3')*SUM(A1,[ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+EPSILON]*
        YIELD2(CTRY,LC1,A1,T)*
...
[
{(1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*SUM(A1,[ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON]*
        YIELD2(CTRY,LC1,A1,T)*
...
CSA(CTRY,LC1,'5')*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))$(R1FOR(CTRY,LC1) EQ 1)

+
[
{(PROPPULP.L(CTRY,LC1,T)+EPSILON)*
SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+EPSILON )*YIELD2(CTRY,LC1,A1,T)*
...
+
(PROPPULP.L(CTRY,LC1,T)+EPSILON)*
CSA(CTRY,LC1,'7')*SUM(A1,(ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON )*YIELD2(CTRY,LC1,A1,T)*
     PARAM2(CTRY,LC1,'8')*((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))$(TEMPINAC(CTRY,LC1) EQ 1)
...
+
(PROPPULP.L(CTRY,LC1,T)+EPSILON)*
CSA(CTRY,LC1,'7')*SUM(A1,[ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T) +EPSILON]*
        YIELD2(CTRY,LC1,A1,T)*
        PARAM2(CTRY,LC1,'8')*((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))$(TROPINAC(CTRY,LC1) EQ 1)
+

[
{(PROPPULP.L(CTRY,LC1,T)+EPSILON)*SUM(A1,[ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+EPSILON]*
        YIELD2(CTRY,LC1,A1,T)*
...
CSA(CTRY,LC1,'5')*[ SUM(A1,((ACHR2.l(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+EPSILON )*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.l(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T))$(DEDBIO(CTRY,LC1) EQ 1)))]+
(SUM(A1,((ACHR2.l(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+EPSILON )*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
...
ACHR2.L(CTRY,LC1,A1,T) +ACHR2l.L(CTRY,LC1,A1,T)+ACHR3.L(CTRY,LC1,A1,T)+ACHRIN1.L(CTRY,LC1,A1,T)));
...
0.5*
[
SUM(A1, (YACRE2L.L(CTRY,LC1,A1,T))*
...
[
SUM(A1, (YACRE2L.L(CTRY,LC1,A1,T))*AADJ(A1)*
...
[
(YACRE2L.L(CTRY,LC1,A1,T))*AADJ(A1)*
...
CPARAM2(CTRY,LC1,'14')*CPARAM2(CTRY,LC1,'15')*(1+CPARAM2(CTRY,LC1,'16'))*
CPARAM2(CTRY,LC1,'17')*[SUM(A1, (YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T)))] $(R1FOR(CTRY,LC1) EQ 1)
;
...
ABVCHEATHAGEL(CTRY,LC1,A1,T)/(YACRE2L.L(CTRY,LC1,A1,T)+EPSILON);
...
CPARAM2(CTRY,LC1,'3')*[(YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T))] $(R1FOR(CTRY,LC1) EQ 1)
+

*tropical semi-inaccessible type
[CPARAM2(CTRY,LC1,'3')*(YACRE2L.L(CTRY,LC1,A1,T))*CYLDINAC(CTRY,LC1,A1,T)*
PARAM2(CTRY,LC1,'8')*
((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T))]$(TROPINAC(CTRY,LC1) EQ 1)
;
...
LITTERACCAGEL(CTRY,LC1,A1,T)$(R1FOR(CTRY,LC1) EQ 1) = (YACRE2L.L(CTRY,LC1,A1,T))*CPARAM2(CTRY,LC1,'28')*
[CYIELD(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,A1,T)+1+EPSILON)**FINPTEL(CTRY,LC1,T))]/
[EPSILON+CYIELD(CTRY,LC1,'15',T)*PARAM2(CTRY,LC1,'8')*((MGMT1.L(CTRY,LC1,'15',T)+1+EPSILON)**FINPTEL(CTRY,LC1,T))]$(R1FOR(CTRY,LC1) EQ 1);
...
{[CPARAM2(CTRY,LC1,'28')*(YACRE2L.L(CTRY,LC1,A1,T))*CYIELD(CTRY,LC1,A1,T)]/
[EPSILON + CYIELD(CTRY,LC1,'15',T)]}$(TEMPINAC(CTRY,LC1) EQ 1)
...
ACPL2L.L(CTRY,LC1,T) - SUM(A1,ACHR2L.L(CTRY,LC1,A1,T))+
       CCNAC1L(CTRY,LC1,T));
...
CSOILR1L(CTRY,LC1,T)$(R1FOR(CTRY,LC1) EQ 1) = CPARAM2(CTRY,LC1,'5')*SUM(A1, CPOLICY(CTRY,LC1,A1))+
SOILC1L(CTRY,LC1,T)+
CPARAM2(CTRY,LC1,'8')*MIN[CCNAC1L(CTRY,LC1,T),0];
...
CPARAM2(CTRY,LC1,'5')*(SUM(A1,YACRE2L.L(CTRY,LC1,A1,T)))
...
PARAMETER FOROUTP2(CTRY,LC1,T);
FOROUTP2(CTRY,LC1,T) = SUM(A1,YACRE2L.L(CTRY,LC1,A1,T))/
(SUM(A1,YACRE2L.L(CTRY,LC1,A1,T)+YACRE2.L(CTRY,LC1,A1,T)));


*Estimate Producer and Consumer Surplus
...
SUM[LC1$(R1FOR(CTRY,LC1) EQ 1),
SUM(A1,
(1-PROPPULP.L(CTRY,LC1,T)+EPSILON)*(ACHR2.L(CTRY,LC1,A1,T)+ ACHR2L.L(CTRY,LC1,A1,T)+EPSILON)*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))]+
* Temperate semi-inaccessible
SUM[LC1$(TEMPINAC(CTRY,LC1) EQ 1),
SUM(A1, (1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*
(ACHR2.L(CTRY,LC1,A1,T)+EPSILON)*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))]+
*temperate inaccessible
* use merchantable yield functions less management effects.
SUM[LC1$(TEMPINAC(CTRY,LC1) EQ 1),
        (1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*PARAM2(CTRY,LC1,'8')*
       SUM(A1,(ACHRIN1.L(CTRY,LC1,A1,T) +EPSILON)*
       YLDINAC(CTRY,LC1,A1,T))]+
*tropical semi-inaccessible
SUM[LC1$(TROPINAC(CTRY,LC1) EQ 1),
...
SUM[LC1$(TROPINAC(CTRY,LC1) EQ 1),
        SUM(A1, (1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*
(ACHR3.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*0.5*PARAM2(CTRY,LC1,'8'))]+
*tropical inacessible – harvest
SUM[LC1$(TROPINAC(CTRY,LC1) EQ 1),
        (1-PROPPULP.L(CTRY,LC1,T) +EPSILON)*PARAM2(CTRY,LC1,'8')*
SUM(A1,(ACHRIN1.L(CTRY,LC1,A1,T) +EPSILON)*YLDINAC(CTRY,LC1,A1,T))]+
...
*accessible timber - with proportion going to Biomass
SUM[LC1$(R1FOR(CTRY,LC1) EQ 1),
SUM(A1, (PROPPULP.L(CTRY,LC1 ,T) +EPSILON)*
(ACHR2.L(CTRY,LC1,A1,T)+ACHR2L.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T)))]+
*dedicated fastgrowing plantations - with proportion going to Biomass
SUM[LC1$(DEDBIO(CTRY,LC1) EQ 1),
 PARAM3(CTRY,LC1,'20')*{SUM(A1,((ACHR2.L(CTRY,LC1,A1,T) +EPSILON)*YIELD2(CTRY,LC1,A1,T)*PARAM2(CTRY,LC1,'8')*
       ((1+MGMT1.L(CTRY,LC1,A1,T))**FINPTEL(CTRY,LC1,T))$(DEDBIO(CTRY,LC1) EQ 1)))}]  +
* Temperate semi-inaccessible
SUM[LC1$(TEMPINAC(CTRY,LC1) EQ 1),
SUM(A1, (PROPPULP.L(CTRY,LC1 ,T) +EPSILON)*
...
SUM[LC1$(TEMPINAC(CTRY,LC1) EQ 1),
        (PROPPULP.L(CTRY,LC1 ,T) +EPSILON)*
        PARAM2(CTRY,LC1,'8')*SUM(A1,(ACHRIN1.L(CTRY,LC1,A1,T) +EPSILON)*
       YLDINAC(CTRY,LC1,A1,T))]+
*tropical semi-inaccessible
SUM[LC1$(TROPINAC(CTRY,LC1) EQ 1),
        SUM(A1, (PROPPULP.L(CTRY,LC1 ,T) +EPSILON)*
...
*tropical inacessible – harvest
SUM[LC1$(TROPINAC(CTRY,LC1) EQ 1),
        (PROPPULP.L(CTRY,LC1 ,T) +EPSILON)*PARAM2(CTRY,LC1,'8')*
       SUM(A1,(ACHRIN1.L(CTRY,LC1,A1,T) +EPSILON)*YLDINAC(CTRY,LC1,A1,T))]+
EPSILON) + EPSILON)**((-1/BF)+1)}$YEAR(T)
...
*REGIONAL PRODUCER SURPLUS
PARAMETER PSCTRY(CTRY,T);
PSCTRY(CTRY,T) = TOTALOUTPUT(CTRY,T)-THARVCOSTCTRY(CTRY,T);

*Global Producer Surplus
PARAMETER PS1(T);
PS1(T) = sum(CTRY, PSCTRY(CTRY,T));

*Global Total Surplus
PARAMETER TS1(T);
TS1(T) = CS1(T) + PS1(T);

PARAMETER SURPLUS(RC,T);
SURPLUS(RC,T) = CS1(T)$(ORD(RC) EQ 1) + PS1(T)$(ORD(RC) EQ 2) +
TS1(T)$(ORD(RC) EQ 3);


FILE GTM_LEAKAGE_SCENARIO_OUTPUT; PUT GTM_LEAKAGE_SCENARIO_OUTPUT; GTM_LEAKAGE_SCENARIO_OUTPUT.PC=5;
PUT / 'NON-DISCOUNTED GLOBAL CONSUMER AND PRODUCER SURPLUS ($)';
PUT / 'YEAR';
PUT 'CS';
PUT 'PS';
PUT 'TS';
LOOP(T, PUT / T.TE(T);LOOP(RC, PUT SURPLUS(RC,T)););
